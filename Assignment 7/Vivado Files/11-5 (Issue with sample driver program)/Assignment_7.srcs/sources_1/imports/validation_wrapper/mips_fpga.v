module mips_fpga (
    ...
    */
    ...
    switches[8:5] = 1000 : Display lower  half word of 'pc_current'
    switches[8:5] = 1001 : Display higher half word of 'pc_current'
    
    switches[8:5] - 1010 : Display lower half word of 'mult_result'
    switches[8:5] - 1011 : Display upper half word of 'mult_result'
    switches[8:5] - 1100 : Display lower half word of 'shift_result'
    switches[8:5] - 1101 : Display upper half word of 'shift_result'
    switch
    */
    ...
    always @ (posedge clk) begin
        case ({switches[8:5]})
            ...
            4'b1010: reg_hex = mult_result[15:0];
            4'b1011: reg_hex = mult_result[31:16];
            4'b1100: reg_hex = shift_result[15:0];
            4'b1101: reg_hex = shift_result[31:16];
