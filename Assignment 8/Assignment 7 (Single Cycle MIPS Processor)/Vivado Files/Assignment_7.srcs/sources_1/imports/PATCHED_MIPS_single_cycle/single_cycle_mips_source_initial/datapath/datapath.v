module datapath (
        ...
        // Outputs for simulation (to remove, remove from here, remove from mips.v outputs and port connect, mips_top.v outputs and port connect, tb_mips_top.v
    ...
    wire [31:0] mfhi;
    wire [31:0] mflo;
//    wire [31:0] mult_result; // Moving to output to display in simulation
//    wire [31:0] shift_result; // Moving to output to display in simulation
